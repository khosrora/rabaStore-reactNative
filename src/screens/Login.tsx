        ...
        <HomeLayout dark={dark} navigation={navigation}>
            ...
            >
                {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                    <View style={{ flex: 1, backgroundColor: dark ? "#000" : "#FFFFFF", padding: 10, display: "flex", justifyContent: "center", alignItems: 'center', rowGap: 50 }}>
                        <View style={{ width: "80%", alignItems: "flex-start", marginLeft: "auto", marginRight: "auto" }}>
                            <Text style={{ fontSize: 20, fontWeight: "bold", color: dark ? "#FFFFFF" : "#000" }}> Welcome </Text>
                            <Text style={{ fontSize: 15 }}> Please login to continue our app </Text>
                        </View>
                        <View style={{ width: "80%", alignItems: "flex-start", marginLeft: "auto", marginRight: "auto" }}>
                            <Text style={{ fontSize: 10, fontWeight: "normal", color: dark ? "#FFFFFF" : "#000" }}> Email </Text>
                            <TextInput
                                onChangeText={handleChange('email')}
                                onBlur={handleBlur('email')}
                                value={values.email}
                                placeholder="youremail@email.com"
                                style={{ borderBottomWidth: 1, borderBottomColor: dark ? "#232323" : "#EDEDED", padding: 0, width: "100%" }}
                            />
                        ...
                        <TouchableOpacity onPress={handleSubmit as unknown as (e: GestureResponderEvent) => void} style={{ width: "80%" }}>
                            <View style={{ backgroundColor: dark ? "#323232" : "#000", padding: 10, width: "100%", borderRadius: 10, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
